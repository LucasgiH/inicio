...
request.onsuccess = function (event) {
   ...
   tab[0].innerHTML=parseInt(inf.popTt)-parseInt(inf.dose3);
   tab[1].innerHTML=inf.popTt;
   tab[2].innerHTML=inf.dose3;
   tab[3].innerHTML=inf.dose2;
   tab[4].innerHTML=inf.dose1;
   tab[5].innerHTML=inf.dtAtual;
