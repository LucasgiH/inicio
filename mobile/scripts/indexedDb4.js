...
request.onsuccess = function (event) {
    ...
    contato.qtd = parseInt(contato.qtd)+ parseInt(inputQtd.value);
...
const displayData=function(){
	...
	objectStore.openCursor().onsuccess=function(event){
		...
		if(cursor){
			...
			const textItem=`estado: ${cursor.value.estado} - imunizados: ${cursor.value.qtd} - ${cursor.value.popTt} - ${cursor.value.id}`;
